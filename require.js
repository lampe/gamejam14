var game = {};
requirejs(['src/gameover', 'src/game','src/byc.js', 'src/enemies/enemies', 'src/enemies/kanonenfutter', 'src/weapons/weapons', 'src/weapons/gun', 'src/weapons/wall', 'src/mainmenu','src/preloader','src/splash','src/boot'],function(){
